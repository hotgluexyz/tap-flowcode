...
You can easily run `tap-flowcode` by itself or in a pipeline using [Meltano](https://meltano.com/).
...
```bash
# Test invocation:
meltano invoke tap-flowcode --version
# OR run a test `elt` pipeline:
meltano elt tap-flowcode target-jsonl
```
